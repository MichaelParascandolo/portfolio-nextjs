        ...
        <div className="max-w-[90%] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
          <div className="col-span-4">
            ...
            <p className="text-gray-700">
              This is my personal portfolio, you are (obviously) here! Users are
              able to learn about me, what I am passionate about, the technology
              I have worked with, see my projects, and get in contact with me.
              For this site I wanted to learn and use a new framework and I
              chose on NextJS. I learned so much about NextJS throughout the
              duration of creating the site and I absolutely fell in love with
              it. Tailwind was used to help easily create a clean and cohesive
              design. TypeScript was added to create a more reliable codebase.
              Framer-motion was used to create all of the nice transitions and
              hover effects that you see on the site. EmailJS handles the
              contact form and makes it functional. Out of all my projects, this
              is by far the one I am most proud of as it fully expresses the
              love I have for creating amazing experiences on the web.
            </p>
